...
module InstallNginxIngress './modules/aks-helm-install/main.bicep' = {
  ...
  params: {
    ...
    helmAppParams: '--namespace ingress-nginx --create-namespace'
    helmAppValues: loadFileAsBase64('./modules/aks-helm-install/ingress-custom-values.yaml')
  }
  dependsOn: [
    akscluster
  ]
